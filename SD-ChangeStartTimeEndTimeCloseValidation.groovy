/**
This Script  is used to validate Business reason field is filled or not if request is closed outside the change window.
**/
...
if(appUser != logedInUser){
    ...
    {
       if(changeStartTimeParse > now || changeEndTimeParse < now ) {
