...
import com.atlassian.jira.config.ResolutionManager;
	...
	ApplicationUser appUser = userManager.getUserByName("ulti");
	...
	def validAPPUser = userManager.getUserByName(userNameValue);//Getting Application user
	...
	if(validAPPUser != null){
		...
		if(typeValue.toString() == "Termination"){
				...
				/**Triggering the python script and readin the output**/
					...
					//def path = '/JIRA/Data/Groovy/listConfluenceGroup.py '+''+ userNameValue +''
